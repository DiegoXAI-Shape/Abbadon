...
| `TransformerDaowa_maad` | ResNet (from scratch) | Transformer Encoder | 3 (RGB) | No
| `Daowa_maadPrueba` | ConvNeXtV2 Tiny (pretrained) | — | 4 (RGB + Fourier) | No
| `Daowa_maadPrueba2` | ConvNeXtV2 Tiny (pretrained) | — | 4 (RGB + Fourier) | Si
